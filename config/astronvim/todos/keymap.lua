...
-- TODO: select next match: Alt + j
-- TODO: deselect latest match: Alt + Shift + j
-- TODO: select all matches in buffer: Ctrl + Shift + Alt + j

-- TODO: collapse block: Ctrl + "-" (keypad)
-- TODO: expand block: Ctrl + "+" (keypad)
